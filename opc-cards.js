(function(){
  ...
  try{ console.log("%c[ONLY POEMS] share-cards v20 loaded","color:#0153db;font-weight:bold"); }catch(e){}
  ...
  /* v20: image poems — visual poems stored as an image asset (or an inline figure image).
