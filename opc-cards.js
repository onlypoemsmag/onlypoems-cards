(function(){
  ...
  try{ console.log("%c[ONLY POEMS] share-cards v17 loaded","color:#0153db;font-weight:bold"); }catch(e){}
  ...
  function init(){
    ...
    function deriveFor(rt){ var poet=info.poet, title=""; var sc=scopeFor(rt);
      ...
      if(!title) title=info.title||titleFor(rt); return {title:title, poet:poet}; }
