...
(function(){
  ...
  try{ console.log("%c[ONLY POEMS] share-cards v15 loaded","color:#0153db;font-weight:bold"); }catch(e){}
  ...
  function init(){
    ...
    if(/random-poem/.test(path)||/\/(tags|read-poems-by-tags)\//.test(path)){ try{
      ...
      for(var _k=0;_k<_cand.length;_k++){ var _c=_cand[_k];
        ...
        if(_c===_pp || _c.matches(".random-poem-poet,.random-poet,.tags-poet-name")) continue;
